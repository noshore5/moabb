"""Minimal mock-data smoke script for WCTPhaseGNNClassifier.

Usage (from repo root):
    python coheriqs_contributions/smoke_wct_phase_gnn_mock.py
"""
